MODULE p4zflx
   ...
   REAL(wp)          ::   d18o_oxy    !: Constant atmospheric d18O of dioxygen       
   REAL(wp)          ::   e18oxy_eq   !: 18O fractionation - equilibrium gas exchange
   REAL(wp)          ::   e18oxy_k    !: 18O fractionation - kinetic gas exchange    
      ...
      DO jj = 1, jpj
         DO ji = 1, jpi
            ...
            IF ( ln_o18 ) THEN
               ...
               ! calculate flux into ocean
               zoflx18(ji,jj) = ( zfld16 * (d18o_oxy/1000. + 1.) * (e18oxy_eq/1000. + 1.)     &
               &                - zflu16*zr18_oxy ) * (e18oxy_k/1000. + 1.) * tmask(ji,jj,1)
               ! update tracer array
